...
public class RandomStringUtils {
	 ...
	 *            characters
	 * @param numbers
	 *            if {@code true}, generated string may include numeric characters
	 * @return the random string
	 */
	 ...
	 *            only allow numbers?
	 * @param chars
	 *            the set of chars to choose randoms from. If {@code null}, then it
	 *            will use the set of all chars.
	 * @return the random string
	 * @throws ArrayIndexOutOfBoundsException
	 *             if there are not {@code (end - start) + 1} characters in the set
	 *             array.
	 */
	public static String random(final int count, final int start, final int end, final boolean letters,
