package com.idea.thought.security;
...
import com.idea.thought.util.Utility;
        ...
        try {
            ...
            if (idToken == null) {
                ...
                if (!username.startsWith("google_")) {
                    optionalAppUser = appUserRepo.findByEmailIgnoreCaseAndIsActiveTrue(username);
                } else {
                    optionalAppUser = appUserRepo.findByGoogleIdAndIsActiveTrue(username);
                }
                ...
                List<GrantedAuthority> grantedAuthorities = optionalAppUser.get().getAuthorities();
