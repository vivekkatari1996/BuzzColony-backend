...
public class SwaggerConfig {
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
                .securitySchemes(Arrays.asList(authorizationKey())).select().paths(PathSelectors.any())
    ...
    private ApiKey authorizationKey() {
        return new ApiKey(Constants.AUTH_HEADER_NAME, Constants.AUTH_HEADER_NAME, "header");
    }
